...
harvestData <- read_excel("K:/CPDiary/Data/BaxtersMVI/Biomass.xlsx", skip = 14, col_names = FALSE, n_max = 24)
...
harvestData <- harvestData  %>%
  filter(Harvest_Num == "H1") ### CHANGE THIS FILTER FOR EACH HARVEST 
```
